...
namespace Service_center {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Login, string Password, string Name, string Surname, string Patronymic) {
...
namespace Service_center.Database1DataSet2TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([Id] = @Original_Id) AND ([Login] = @Origina" +
                "l_Login) AND ([Password] = @Original_Password) AND ([Name] = @Original_Name) AND" +
                " ([Surname] = @Original_Surname) AND ([Patronymic] = @Original_Patronymic))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Login], [Password], [Name], [Surname], [Patronymic" +
                "]) VALUES (@Login, @Password, @Name, @Surname, @Patronymic);\r\nSELECT Id, Login, " +
                "Password, Name, Surname, Patronymic FROM Employee WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Login] = @Login, [Password] = @Password, [Name] = @Name, [Surname] = @Surname, [Patronymic] = @Patronymic WHERE (([Id] = @Original_Id) AND ([Login] = @Original_Login) AND ([Password] = @Original_Password) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Patronymic] = @Original_Patronymic));
SELECT Id, Login, Password, Name, Surname, Patronymic FROM Employee WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Login, Password, Name, Surname, Patronymic FROM dbo.Employee";
        ...
        public virtual int Delete(int Original_Id, string Original_Login, string Original_Password, string Original_Name, string Original_Surname, string Original_Patronymic) {
        ...
        public virtual int Insert(string Login, string Password, string Name, string Surname, string Patronymic) {
            if ((Login == null)) {
        ...
        public virtual int Update(string Login, string Password, string Name, string Surname, string Patronymic, int Original_Id, string Original_Login, string Original_Password, string Original_Name, string Original_Surname, string Original_Patronymic, int Id) {
            if ((Login == null)) {
                throw new global::System.ArgumentNullException("Login");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Login, string Password, string Name, string Surname, string Patronymic, int Original_Id, string Original_Login, string Original_Password, string Original_Name, string Original_Surname, string Original_Patronymic) {
            return this.Update(Login, Password, Name, Surname, Patronymic, Original_Id, Original_Login, Original_Password, Original_Name, Original_Surname, Original_Patronymic, Original_Id);
        }
    }
